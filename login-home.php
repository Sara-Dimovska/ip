...
<div class="container-fluid">
    ...
    <div style="width:100%;height:80px;">
        ...
        <form action="index.php" method="post" class="navbar-form" style="float:right; ">
            ...
            <?php } else { ?>
            <a href="index.php" class="btn btn-default  navbar-btn" style="float: right;color: white !important ;background-color: #840303 !important;margin-right:30px;">Одјави се</a>
            <?php }?>
    ...
    <div style="width:100%;height:180px; background-color:whitesmoke; border-radius: 5px; margin-bottom:30px;">
        ...
        <div class="nav-left">
            ...
            <a href="login-home.php" class="btn btn-default  navbar-btn" style="
            ...
            <?php if($fgmembersite->User_type() == 'корисник') {?>
                <a href="moiOglasi.php" class="btn btn-default  navbar-btn" style="
																			   display: inline-block;color: white !important ;
																			   background-color: #dd6464 !important;
																			   ">Мои огласи</a>
            <?php }?>
            <?php if($fgmembersite->User_type() == 'корисник') {?>
                <a href="zacuvaniOglasi.php" class="btn btn-default  navbar-btn" style="
																			   display: inline-block;color: white !important ;
																			   background-color: #dd6464 !important;
																			   ">Зачувани огласи</a>
            <?php }?>
            ...
            <?php if($fgmembersite->User_type() == 'модератор') {?>
                <a href="login-home.php" class="btn btn-default  navbar-btn" style="
																			   display: inline-block;color: white !important ;
																			   background-color: #dd6464 !important;
																			   ">Огласи со барање за објава</a>
            <?php }?>
            <?php if($fgmembersite->User_type() == 'модератор') {?>
                <a href="login-home.php" class="btn btn-default  navbar-btn" style="
																			   display: inline-block;color: white !important ;
																			   background-color: #dd6464 !important;
																			   ">Мои одобрени огласи</a>
            <?php }?>
            <?php if ((($fgmembersite->User_type() == 'админ') || ($fgmembersite->User_type() == 'модератор')) && ($fgmembersite->User_type() != 'корисник')) { ?>
                <a href="login-home.php" class="btn btn-default  navbar-btn" style="
																			   display: inline-block;color: white !important ;
																			   background-color: #dd6464 !important;
																			   ">Листа на корисници</a>
            <?php }?>
            <?php if( ($fgmembersite->User_type() == 'админ') || ($fgmembersite->User_type() == 'модератор') || ($fgmembersite->User_type() == 'корисник')) {?>
                <a href="login-home.php" class="btn btn-default  navbar-btn" style="
																			   display: inline-block;color: white !important ;
...

            {
                ...
                if (isset($_POST['filter'])) {
                    ...
                    while ($row = mysqli_fetch_array($sendSQL)) {
                        ...
                        switch ($row['tip_cena']) {
                            case 'Евра':
                                echo '<br>Цена: <div style="height:30px;padding:5px;display: inline; border-radius:4px; background-color:green;">' . $row['cena'] . ' &euro; </div>';
                                break;
                            case 'По договор':
                                echo '<br>Цена: <div style="height:30px;padding:5px;display: inline; border-radius:4px; background-color:yellow; color:black;">По договор</div>';
                                break;
                        }
                        echo "</div>";
                        echo "</div>";
